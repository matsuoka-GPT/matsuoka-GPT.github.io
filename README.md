...
- `members.html` and `jp/members-en.html` — English/Japanese member pages.
- `structure-art-gallery.html` and `jp/structure-art-gallery-en.html` — English/Japanese structure-art gallery pages.
...
- `en/` — Compatibility redirects from old `/en/` URLs to the new `/jp/` URLs.
...
- Japanese members: `/jp/members-en.html`
- English structure-art gallery: `/structure-art-gallery.html`
- Japanese structure-art gallery: `/jp/structure-art-gallery-en.html`
...
3. When adding Japanese home/member/gallery pages, place them under `jp/` and update any old `/en/` references to `/jp/`.
